...
class Turtle_Controller(Node): 
    def __init__(self):
        ...
        self.reset_counter_service_ = self.create_service(ActivateTurtle, "activate_turtle", self.callback_activate_turtle)
